            ...
            @foreach ($categories as $category)
                <a href="{{ route('books', ['selectedCategory' => $category]) }}"
                    ...
                    @switch($category)
                        ...
                        @case('hadis')
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-emerald-600 mb-2" viewBox="0 0 24 24"
                    ...
                    @endswitch
                    <span
                        class="text-sm font-medium text-gray-700">{{ str_replace('-', ' ', ucwords($category)) }}</span>
                </a>
            @endforeach
        </div>
    </section>
